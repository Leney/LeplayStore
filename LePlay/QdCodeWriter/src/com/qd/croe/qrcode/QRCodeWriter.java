...
import com.qd.croe.qrcode.encoder.ByteMatrix;
import com.qd.croe.qrcode.encoder.Encoder;
import com.qd.croe.qrcode.encoder.QRCode;
...
public final class QRCodeWriter implements Writer
{
			...
			int height, Map<EncodeHintType, ?> hints) throws WriterException
	{
		...
		if (hints != null)
		{
			...
			{
				errorCorrectionLevel = ErrorCorrectionLevel.valueOf(hints.get(
						EncodeHintType.ERROR_CORRECTION).toString());
			}
