 ...
 *
 */
public class IgnoreAdapter extends UpdateDownloadBaseAdapter<MarketListView>
{
	...
	public IgnoreAdapter(Context context, MarketListView listView,
	...
	public class SoftListViewHolder
	{
		...
		public void init(View baseView)
		{
			...
			ignoreApp = (TextView) baseView
					.findViewById(R.id.update_cancle_ignore_app);
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		if (convertView == null)
		{
			...
			holder.ignoreApp.setOnClickListener(cancleIgnoreAppOnClickListener);
		} else
		{
	 ...
	 * 取消 的点击事件
	 */
	public OnClickListener cancleIgnoreAppOnClickListener = new OnClickListener()
	{
		@Override
		public void onClick(View v)
		{
