 ...
 *
 */
public class GetCoinAppFragment extends BaseTabChildFragment
{
	private static final String TAG = "GetCoinAppFragment";
	...
	/** 玩赚金币应用列表的etag标识值 */
	private String etagMark = "getCoinAppList";

	public static GetCoinAppFragment getInstance(String beforeAction)
	{
		thisAction = DataCollectionManager.getAction(beforeAction,
				DataCollectionConstant.DATA_COLLECTION_GAIN_COIN_APP_VALUE);
		return new GetCoinAppFragment();
	}
