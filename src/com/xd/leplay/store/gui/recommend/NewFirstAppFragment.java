 ...
 *
 */
public class NewFirstAppFragment extends BaseTabChildFragment
{
	private static final String TAG = "NewFirstAppFragment";
	...
	/** 新品首发应用列表的etag标识值 */
	private String etagMark = "newFirstAppList";

	public static NewFirstAppFragment getInstance(String beforeAction)
	{
		thisAction = DataCollectionManager.getAction(beforeAction,
				DataCollectionConstant.DATA_COLLECTION_NEW_FIRST_APP_VALUE);
		return new NewFirstAppFragment();
	}
