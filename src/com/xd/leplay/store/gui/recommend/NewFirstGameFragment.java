 ...
 *
 */
public class NewFirstGameFragment extends BaseTabChildFragment
{
	private static final String TAG = "NewFirstGameFragment";
	...
	/** 新品首发游戏列表的etag标识值 */
	private String etagMark = "newFirstGameList";

	public static NewFirstGameFragment getInstance(String beforeAction)
	{
		thisAction = DataCollectionManager.getAction(beforeAction,
				DataCollectionConstant.DATA_COLLECTION_NEW_FIRST_GAME_VALUE);
		return new NewFirstGameFragment();
	}
