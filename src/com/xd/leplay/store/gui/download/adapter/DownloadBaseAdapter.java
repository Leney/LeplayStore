 ...
 * 
 */
public abstract class DownloadBaseAdapter<T extends AbsListView> extends
		BaseAdapter
{

	/** 列表数据 */
	protected ArrayList<? extends ListAppInfo> appInfos;
	...
	public List<? extends ListAppInfo> getAppInfos()
	{
		return appInfos;
	}

	public void setAppInfos(ArrayList<? extends ListAppInfo> appInfos)
	{
	 ...
	 * 构造方法
	 */
	public DownloadBaseAdapter(Context context, T listView,
			ArrayList<? extends ListAppInfo> appInfos)
	{
	...
	protected View matchViewToRefreshData(DownloadInfo downloadInfo)
	{
		...
		ArrayList<? extends ListAppInfo> list = (ArrayList<? extends ListAppInfo>) appInfos
				.clone();
