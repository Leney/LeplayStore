...
public class ApplicationBoutiqueFragment extends BaseTabChildFragment
{
	...
	public static ApplicationBoutiqueFragment getInstance(String beforeAction)
	{
		thisAction = DataCollectionManager.getAction(beforeAction,
				DataCollectionConstant.DATA_COLLECTION_APP_BOUTIQUE_VALUE);
	...
	protected void initView(FrameLayout view)
	{
		...
		bannerView
				.setAction(DataCollectionManager
						.getAction(
								action,
								DataCollectionConstant.DATA_COLLECTION_APP_BOUTIQUE_CLICK_TOP_BANNER_VALUE));
//		headerLeftAdImg = (ImageView) headerView
//				.findViewById(R.id.application_boutique_left_ad_img);
//		headerLeftAdImg
//				.setImageResource(R.drawable.application_header_left_lay);
...
//				.setOnClickListener(headerLeftAndRightAdImgOnClickListener);
	 ...
	 */
	// private OnClickListener headerLeftAndRightAdImgOnClickListener = new
	// OnClickListener()
	// {
	// @Override
	// public void onClick(View v)
	...
	// .getAction(
	// action,
	// DataCollectionConstant.DATA_COLLECTION_APP_BOUTIQUE_CLICK_LEFT_BANNER_VALUE));
	// break;
	// case 2:
	// // webview链接
	...
	// String etagMark = "applicationBoutiqueBannerClassify"
	// + appTypeId;
	...
	// break;
	// }
	// if (v.getId() == R.id.application_boutique_left_ad_img)
	// {
	// // 多盟积分墙自己后台数据采集
	// String headerLeftAdImgAction = DataCollectionManager
	// .getAction(
	// action,
	// DataCollectionConstant.DATA_COLLECTION_CLICK_DUOMENG_INTEGRAL_WALL_VALUE);
	// DataCollectionManager.getInstance().addRecord(
	// headerLeftAdImgAction);
	// DataCollectionManager
	// .getInstance()
	// .addYouMengEventRecord(
	// getActivity(),
	// action,
	// DataCollectionConstant.EVENT_ID_IN_DUOMENG_INTEGRAL_WALL,
	// null);
	// if (ToolsUtil.checkNetwork(getActivity()) == false)
	// {
	// Toast.makeText(
	// getActivity(),
	...
	// } else if (v.getId() == R.id.application_boutique_right_ad_img)
	// {
	// // 数据采集
	// String headerRightAdImgAction = DataCollectionManager
	// .getAction(
	// action,
	// DataCollectionConstant.DATA_COLLECTION_CLICK_DIANRU_INTEGRAL_WALL_VALUE);
	// DataCollectionManager.getInstance().addRecord(
	...
	// getActivity(),
	// action,
	// DataCollectionConstant.EVENT_ID_CLICK_DIANRU_INTEGRAL_WALL,
	// null);
	// // 启动点入积分墙界面
	// DRSdk.showOfferWall(getActivity(), DRSdk.DR_OFFER);
	// }
	// }
	// };
	...
	private BroadcastReceiver receiver = new BroadcastReceiver()
	{
		...
		public void onReceive(Context context, Intent intent)
		{
			if (Constants.ACTION_NO_PIC_MODEL_CHANGE.equals(intent.getAction()))
			{
				...
				// .getAdsPicUrlLand(), headerLeftAdImg,
				// adImgOptions);
				// headerLeftAdImg.setTag(imgAdElements.get(i));
				// } else if (i == 1)
				// {
