 ...
 *
 */
public class GameRankFragment extends BaseTabChildFragment
{
	 ...
	 */
	private final int LIST_TYPE = 10;
	...
	/** 游戏排行列表的etag标识值 */
	private String etagMark = "gameRankList";

	public static GameRankFragment getInstance(String beforeAction)
	{
		thisAction = DataCollectionManager.getAction(beforeAction,
				DataCollectionConstant.DATA_COLLECTION_GAME_RANK_VALUE);
