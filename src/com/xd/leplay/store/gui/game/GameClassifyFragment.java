 ...
 *
 */
public class GameClassifyFragment extends BaseTabChildFragment
{
	...
	/** 分类的类型 ,11=应用,12=游戏 */
	private final int CLASSIFY_TYPE = 12;
	...
	/** 游戏分类列表的etag标识值 */
	private String etagMark = "gameClassifyList";

	public static GameClassifyFragment getInstance(String beforeAction)
	{
		thisAction = DataCollectionManager.getAction(beforeAction,
				DataCollectionConstant.DATA_COLLECTION_GAME_CLASSFIY_VALUE);
