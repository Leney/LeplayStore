...
class SlidingTabStrip extends LinearLayout
{
	...
	private static final int DEFAULT_SELECTED_INDICATOR_COLOR = 0xff8400;
	...
	/** 各tab之间的间隔距离 */
	private final int spaceWidth = DisplayUtil.px2dip(getContext(), 60);
	...
	void setBottomBackground(int color)
	{
	...
	protected void onDraw(Canvas canvas)
	{
		...
		if (childCount > 1)
		{
			...
			/** 下划线指示器 */
			canvas.drawRect(left + spaceWidth, height
					- mSelectedIndicatorThickness, right - spaceWidth, height,
		...
		for (int i = 0; i < childCount - 1; i++)
		{
			...
			// TODO 设置指示器的整个背景的颜色
			mDividerPaint.setColor(getResources().getColor(
