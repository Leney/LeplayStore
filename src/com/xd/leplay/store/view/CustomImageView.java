	...
	public CustomImageView(Context context, AttributeSet attrs, int defStyle)
	{
		...
		for (int i = 0; i < n; i++)
		{
			...
			case R.styleable.CustomImageView_borderRadius:
				...
				break;
			case R.styleable.CustomImageView_outCircleWidth:
				outerWidth = a.getDimensionPixelSize(attr, 0);
				break;
			case R.styleable.CustomImageView_outCircleColor:
				outerColor = a.getColor(attr, 0xffffff);
				break;
			}
		}
		a.recycle();
